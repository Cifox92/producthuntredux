...
const Producto = () => {
    ...
    const [consultarDB, guardarConsultarDB] = useState(true) //Sistema para gestionar las consultas
    ...
    //Función para identificar si el usuario que comenta es creador del producto
    const esCreador = id => {
        if(creador.id === id) {
            return true
        }
    ...
    const agregarComentario = e => {
        ...
        //Tomar copia de comentarios y agregar el nuevo comentario al array
